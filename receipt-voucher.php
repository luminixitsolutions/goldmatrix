...
if (!empty($edit_voucher) && is_array($edit_voucher)) {
    ...
    if (!empty($edit_voucher['due_date'])) {
        $rv_due_date_val = substr($edit_voucher['due_date'], 0, 10);
    }
}
...
<head>
    <title>Receipt Voucher - AuraGold Software</title>
    <meta charset="utf-8">
...
<?php require __DIR__ . '/includes/voucher_diamond_stone_panels.php'; ?>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: 'ajax/get-receipt-vouchers.php',
            method: 'GET',
            data: { limit: 100 },
            dataType: 'json',
            success: function(response) {
