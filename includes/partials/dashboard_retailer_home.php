<?php
/**
 * JewelSteps-style retailer home (CUSTOMER type). Expects dashboard_helpers loaded.
 */
...
/* Stack chart + market on phones/tablets; chart fill width */
...
<div class="retail-hero">
    <div>
        ...
        <div class="sub">Today’s sales, purchases, orders, collections, and market rates — customers with type <strong>Customer</strong> (retail).</div>
    </div>
    <div class="d-flex align-items-center gap-2 flex-wrap">
        <span class="retail-badge">Retailer Dashboard</span>
...
<?php if ((int) ($rd['retailer_type_id'] ?? 0) <= 0): ?>
    <div class="alert alert-warning py-2">Customer type <code>CUSTOMER</code> not found in masters. KPIs use all customers until the type exists.</div>
<?php endif; ?>
    ...
    <div class="col-6 col-md-4 col-xl-2">
        <div class="retail-kpi kpi-cash h-100">
            ...
            <div>
                ...
                <div class="bal">Current balance: <strong><?php echo auragold_fmt_money($rd['balance_cash']); ?></strong></div>
                <div class="view-all"><a href="<?php echo htmlspecialchars($url_ledger_all('Cash')); ?>">View all</a></div>
            </div>
        </div>
    </div>
    <div class="col-6 col-md-4 col-xl-2">
        <div class="retail-kpi kpi-bank h-100">
            ...
            <div>
                ...
                <div class="bal">Current balance: <strong><?php echo auragold_fmt_money($rd['balance_bank']); ?></strong></div>
                <div class="view-all"><a href="<?php echo htmlspecialchars($url_ledger_all('Bank Account')); ?>">View all</a></div>
            </div>
        </div>
    </div>
    <div class="col-6 col-md-4 col-xl-2">
        <div class="retail-kpi kpi-card h-100">
            ...
            <div>
                ...
                <div class="bal">Current balance: <strong><?php echo auragold_fmt_money($rd['balance_card']); ?></strong></div>
                <div class="view-all"><a href="<?php echo htmlspecialchars($url_ledger_all('Card')); ?>">View all</a></div>
            </div>
        </div>
    </div>
</div>
...
<div class="row g-3 align-items-stretch">
    ...
    <div class="col-12 col-lg-4">
        <div class="retail-market h-100">
            <h2>Market prices</h2>
            <div class="retail-market-row"><span class="k">18k</span><span class="v"><?php echo htmlspecialchars(auragold_market_rate($rd['market']['18k'] ?? null)); ?></span></div>
            <div class="retail-market-row"><span class="k">21k</span><span class="v"><?php echo htmlspecialchars(auragold_market_rate($rd['market']['21k'] ?? null)); ?></span></div>
            <div class="retail-market-row"><span class="k">22k</span><span class="v"><?php echo htmlspecialchars(auragold_market_rate($rd['market']['22k'] ?? null)); ?></span></div>
            <div class="retail-market-row"><span class="k">24k</span><span class="v"><?php echo htmlspecialchars(auragold_market_rate($rd['market']['24k'] ?? null)); ?></span></div>
...
<div class="retail-foot">
    <span>AuraGold · Retailer dashboard</span>
...
(function() {
    ...
    window.addEventListener('resize', function() {
        if (window.requestAnimationFrame) {
            window.requestAnimationFrame(resizeRetailChart);
        } else {
            resizeRetailChart();
        }
    });
