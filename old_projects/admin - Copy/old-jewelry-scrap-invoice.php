...
<script>
     ...
     */
    function isProductLineInProductList(barcode, characteristicId, purchaseInvoiceItemId) {
            ...
            .then(data => {
                if (data.success && data.products && data.products.length) {
                    ...
                    for (var pi = 0; pi < data.products.length; pi++) {
                        ...
                        if (isProductLineInProductList(rbc, rcid, pr.purchase_invoice_item_id)) {
                            continue;
                        }
                ...
                if (data.success && data.product) {
                    ...
                    if (isProductLineInProductList(resolvedBc, resCid, data.product.purchase_invoice_item_id)) {
                            ...
                            .then(function(d2) {
                                if (d2.success && d2.products && d2.products.length) {
                                    for (var j = 0; j < d2.products.length; j++) {
                                        ...
                                        if (!isProductLineInProductList(b2, c2, p2.purchase_invoice_item_id)) {
                                    ...
                                    if (!isProductLineInProductList(b2, c2, d2.product.purchase_invoice_item_id)) {
