...
// Physical folder: {project}/admin/uploads/stock_journal/  (this file is admin/ajax/; parent dir is admin/)
// DB image_path stores: uploads/stock_journal/<filename>  (browser URL must include /admin/ before uploads/)
