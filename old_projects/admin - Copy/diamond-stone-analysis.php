...
// Scope to login branch when no branch in URL; use ?branch=0 (All Branches) to show every branch.
if ($branch_filter <= 0 && $dsa_effective_branch_id > 0 && !isset($_GET['branch'])) {
    $branch_filter = $dsa_effective_branch_id;
}

// This page: Diamond & Stones stock only (tbl_metal.display_name)
                                    ...
                                    <div class="stock-analysis-wrapper">
                                        ...
                                        <div class="tabs-container">
                                            ...
                                            <div class="tabs-bar-actions">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button" class="btn-icon" title="Export" data-toggle="dropdown"><i class="feather icon-download"></i></button>
