                            ...
                            <div class="jwq-mat-table-wrap" id="jwqMatTableWrap">
                                <table class="jwq-mat-table">
                                    ...
                                    <tbody id="jwqMaterialBody">
                                        <tr><td colspan="7" class="jwq-mat-empty">No Rows To Show</td></tr>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-striped mb-0 jwq-diamond-used-table">
                        ...
                        <tbody id="jwqDiamondUsedModalBody">
                            <tr><td colspan="7" class="text-center text-muted p-3">No data</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
...
<script src="includes/jobwork-queue-page.js?v=20"></script>
</body>
</html>
