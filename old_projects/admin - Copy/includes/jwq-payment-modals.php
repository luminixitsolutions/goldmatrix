...
(function () {
    ...
    function jwqRefreshJobworkMaterialTotalWt() {
        ...
        var sum = 0;
        body.querySelectorAll('tr .jwq-mat-wt').forEach(function (td) {
    ...
    function jwqAppendDiamondRowsToJobworkMaterialTable(rows) {
        ...
        rows.forEach(function (r) {
            ...
            tr.innerHTML = '<td>' + cat + '</td><td>' + prod + '</td><td class="jwq-mat-wt">' + wtDisp + '</td><td>' + metal + '</td><td>' + qtyDisp + '</td><td>' + esc(caratStr) + '</td><td></td>';
    ...
    function buildRowHtml(r, i, editable) {
        ...
        var trOpen = '<tr class="jwq-diamond-stock-modal-row"'
            ...
            + '>';
        return trOpen
            + '<td data-col="row_chk"><input class="jwq-dia-row" type="checkbox"></td>'
