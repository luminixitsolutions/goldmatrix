                        ...
                        <div class="col-lg-8" >
                            ...
                            <div class="card mb-4">
                                <div class="card-body billing-form">
                                        ...
                                        ?>
                                        <div class="row align-items-end si-invoice-billing-grid">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-12 mt-2 pt-1 border-top si-eway-options-row">
                                                <div class="form-row align-items-center">
                                                    <div class="col-sm-6 col-md-6">
                                                        <div class="form-check mb-0">
                                                            ...
                                                            <label class="form-check-label small font-weight-bold text-dark mb-0" for="enableEwayBill">Enable e-Way Bill on save</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6 col-md-6">
                                                        <div class="form-check mb-0">
                                                            <input class="form-check-input" type="checkbox" id="siEwaySandboxSampleFlag">
                                                            <label class="form-check-label small text-muted mb-0 eway-sandbox-sample-wrap" for="siEwaySandboxSampleFlag" title="Uses WhiteBooks sandbox sample JSON (requires sandbox URL in e-Way settings).">Force sample payload</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
