                                ...
                                <div class="card-body billing-form">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div style="position: relative;">
                                                        <input type="text" class="form-control form-control-sm" id="customerName" placeholder="Enter supplier name" required style="padding-right: 35px;" autocomplete="off">
                                                        ...
                                                        <i class="feather icon-plus add-customer-icon" id="addCustomerBtn" style="position: absolute; right: 8px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #c5a864; font-size: 1.1rem; z-index: 10; pointer-events: auto;" title="Add New Supplier"></i>
                                        ...
                                        if (!empty($edit_order) && is_array($edit_order)) {
                                            if (!empty($edit_order['quotation_date'])) {
                                                ...
                                                $sq_due_date_val = !empty($edit_order['due_date']) ? substr($edit_order['due_date'], 0, 10) : $sq_order_date_val;
                                            } else {
                                                $sq_due_date_val = !empty($edit_order['due_date']) ? substr($edit_order['due_date'], 0, 10) : $sq_due_date_val;
                                            }
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Handle quotation selection from suggestions
