...
$where_clause = "s.status = 1 AND s.stock_type IN ('opening', 'purchase', 'stock_journal', 'outward', 'balance')";
if ($search_term != '') {
...
$stock_inner_select = "
    SELECT 
        ...
        SUM(
            CASE 
                WHEN s.stock_type IN ('opening','purchase','stock_journal','balance')
        ...
        SUM(CASE WHEN s.stock_type IN ('opening','purchase','stock_journal','balance') THEN COALESCE(NULLIF(s.current_weight, 0), s.opening_weight, 0) ELSE 0 END) as inward_gross_sum,
        SUM(CASE WHEN s.stock_type IN ('opening','purchase','stock_journal','balance') THEN COALESCE(NULLIF(s.current_weight, 0), s.opening_weight, 0) * (CASE WHEN COALESCE(s.opening_purity, 0) <= 1 THEN COALESCE(s.opening_purity, 0) ELSE COALESCE(s.opening_purity, 0) / 100 END) ELSE 0 END) as inward_pure_sum,
        ...
        (SUM(CASE WHEN s.stock_type IN ('opening','purchase','stock_journal','balance') THEN COALESCE(NULLIF(s.current_weight, 0), s.opening_weight, 0) ELSE 0 END) - SUM(CASE WHEN s.stock_type = 'outward' THEN COALESCE(NULLIF(s.current_weight, 0), s.opening_weight, 0) ELSE 0 END)) as stock_net_weight,
        ...
        SUM(CASE WHEN s.stock_type IN ('opening','purchase','stock_journal','balance') THEN COALESCE(NULLIF(s.current_qty, 0), s.opening_qty, 0) ELSE 0 END) as inward_receipt_qty_sum,
        SUM(CASE WHEN s.stock_type IN ('opening','purchase','stock_journal','balance') THEN COALESCE(NULLIF(s.current_weight, 0), s.opening_weight, 0) ELSE 0 END) as inward_receipt_weight_sum,
        SUM(CASE WHEN s.stock_type IN ('opening','purchase','stock_journal','balance') THEN COALESCE(NULLIF(s.current_weight, 0), s.opening_weight, 0) * (CASE WHEN COALESCE(s.opening_purity, 0) <= 1 THEN COALESCE(s.opening_purity, 0) ELSE COALESCE(s.opening_purity, 0) / 100 END) ELSE 0 END) as inward_receipt_pure_sum,
        ...
        CASE WHEN SUM(CASE WHEN s.stock_type IN ('opening','purchase','stock_journal','balance') THEN COALESCE(NULLIF(s.current_weight, 0), s.opening_weight, 0) ELSE 0 END) > 0 THEN SUM(CASE WHEN s.stock_type IN ('opening','purchase','stock_journal','balance') THEN COALESCE(NULLIF(s.current_weight, 0), s.opening_weight, 0) * COALESCE(s.opening_purity, 0) ELSE 0 END) / SUM(CASE WHEN s.stock_type IN ('opening','purchase','stock_journal','balance') THEN COALESCE(NULLIF(s.current_weight, 0), s.opening_weight, 0) ELSE 0 END) ELSE MAX(s.opening_purity) END as opening_purity,
        ...
        SUM(CASE WHEN s.stock_type IN ('purchase','stock_journal','balance') THEN COALESCE(NULLIF(s.current_weight, 0), s.opening_weight, 0) ELSE 0 END) AS sd_gross_in,
        ...
        SUM(CASE WHEN s.stock_type IN ('purchase','stock_journal','balance') THEN COALESCE(NULLIF(s.current_weight, 0), s.opening_weight, 0) * (CASE WHEN COALESCE(s.opening_purity, 0) <= 1 THEN COALESCE(s.opening_purity, 0) ELSE COALESCE(s.opening_purity, 0) / 100 END) ELSE 0 END) AS sd_pure_in,
        ...
        SUM(CASE WHEN s.stock_type IN ('purchase','stock_journal','balance') THEN COALESCE(NULLIF(s.current_qty, 0), s.opening_qty, 0) ELSE 0 END) AS sd_pcs_in,
...
$filter_products = getList("
    ...
    WHERE p.status = 1 AND EXISTS (
        ...
        AND s0.stock_type IN ('opening','purchase','stock_journal','outward','balance')
        $gsa_filter_stock_exists_sql
